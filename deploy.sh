...
echo "EKS NodeGroups:"
echo "  core:          ${CORE_NODE_INSTANCE_TYPE:-c6i.xlarge} (desired=${CORE_NODE_DESIRED_SIZE:-1} min=${CORE_NODE_MIN_SIZE:-1} max=${CORE_NODE_MAX_SIZE:-1} disk=${CORE_NODE_DISK_SIZE:-200}Gi)"
...
echo "  dynamic:       ${DYNAMIC_NODE_INSTANCE_TYPE:-c6i.large} (desired=${DYNAMIC_NODE_DESIRED_SIZE:-3} min=${DYNAMIC_NODE_MIN_SIZE:-3} max=${DYNAMIC_NODE_MAX_SIZE:-3})"
...
PARAMS="${PARAMS} ParameterKey=CoreNodeDiskSize,ParameterValue=${CORE_NODE_DISK_SIZE:-200}"
...
PARAMS="${PARAMS} ParameterKey=DynamicNodeMinSize,ParameterValue=${DYNAMIC_NODE_MIN_SIZE:-3}"
PARAMS="${PARAMS} ParameterKey=DynamicNodeMaxSize,ParameterValue=${DYNAMIC_NODE_MAX_SIZE:-3}"
PARAMS="${PARAMS} ParameterKey=DynamicNodeDesiredSize,ParameterValue=${DYNAMIC_NODE_DESIRED_SIZE:-3}"
